	...
	prs := []model.PullRequest{
		{
			...
			Author: "octodev", URL: "https://github.com/acme/api/pull/412",
		...
		},
		{
			...
			RequestedReviewers: []string{"octodev", "platform-team"}, Checks: passing,
		},
		{
		...
		},
		{
			...
			Author: "octodev", URL: "https://github.com/acme/api/pull/396",
